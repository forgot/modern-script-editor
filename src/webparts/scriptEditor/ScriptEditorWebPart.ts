...
export default class ScriptEditorWebPart extends BaseClientSideWebPart<IScriptEditorWebPartProps> {
    ...
    private checkPermissions(): void {
        this.permission = new SPPermission(this.context.pageContext.web.permissions.value);
        this.hasPermission = this.permission.hasPermission(SPPermission.manageWeb);
    }
    ...
    protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
        let webPartOptions: IPropertyPaneField<any>[] = [
            PropertyPaneTextField("title", {
                label: "Description to show in edit mode",
